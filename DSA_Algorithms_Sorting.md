...
- [C# Sorting](#c-sorting)
  - [The Main Algorithm: Introspective Sort (IntroSort)](#1-the-main-algorithm-introspective-sort-introsort)
    - [Starts with Quick Sort](#starts-with-quick-sort)
    - [Switches to Heap Sort (Safety Net)](#switches-to-heap-sort-safety-net)
    - [Finishes with Insertion Sort (Micro-Optimization)](#finishes-with-insertion-sort-micro-optimization)
  - [The Exception: LINQ (OrderBy)](#2-the-exception-linq-orderby)
  - [Summary Comparison](#summary-comparison)
  - [Deep Dive: Why IntroSort?](#deep-dive-why-introsort)
- [Python Sorting](#python-sorting)
  ...
  - [Usage in Python](#usage-in-python)
    ...
    - [sorted()](#sorted)
- [Galloping](#galloping)
  - [The Problem: The Standard Merge](#the-problem-the-standard-merge)
  - [The Solution: Galloping Mode](#the-solution-galloping-mode)
...
- [Quick Sort](#quick-sort)
  ...
  - [In-Place Quick Sort](#in-place-quick-sort)
    - [The In-Place Algorithm](#the-in-place-algorithm)
  - [Solving the $O(n^2)$ Problem: Random Pivoting](#solving-the-on2-problem-random-pivoting)
  - [Summary Table: Quick Sort vs. Others](#summary-table-quick-sort-vs-others)
  - [Pros & Cons](#pros--cons)
- [Why Quick Sort is Fast in Practice](#why-quick-sort-is-fast-in-practice)
  - [Cache Locality (The "Secret Sauce")](#cache-locality-the-secret-sauce)
  - [Low Overhead (Minimal "Paperwork")](#low-overhead-minimal-paperwork)
  - [Tail Recursion](#tail-recursion)
  - [The Comparison: Quick Sort vs. Merge Sort](#the-comparison-quick-sort-vs-merge-sort)
  - [Summary of the "Real World" Edge](#summary-of-the-real-world-edge)
- [Tail Recursion](#tail-recursion)
  - [The "Standard" vs. "Tail" Difference](#the-standard-vs-tail-difference)
    - [Standard Recursion (Not Tail-Recursive)](#standard-recursion-not-tail-recursive)
    - [Tail Recursion](#tail-recursion-1)
  - [The Magic: Tail Call Optimization (TCO)](#the-magic-tail-call-optimization-tco)
  - [A Quick Summary Table](#a-quick-summary-table)
- [Merge Sort](#merge-sort)
  - [How It Works: The Strategy](#how-it-works-the-strategy)
    - [Divide](#divide)
    - [Conquer (Merge)](#conquer-merge)
  - [The Step-by-Step Logic](#the-step-by-step-logic)
  - [Efficiency and Performance](#efficiency-and-performance)
  - [Why use Merge Sort?](#why-use-merge-sort)
  - [Why this works](#why-this-works)
  - [Complexity Recap](#complexity-recap)
- [Merge Sort vs Quick Sort](#merge-sort-vs-quick-sort)
  - [When to choose Merge Sort](#1-when-to-choose-merge-sort)
  - [When to choose Quick Sort](#2-when-to-choose-quick-sort)
  - [Side-by-Side Comparison](#side-by-side-comparison)
  - [The "Hybrid" Reality](#the-hybrid-reality)
  - [Why Quick Sort usually wins on speed](#why-quick-sort-usually-wins-on-speed)
    - [The "Hidden" Constant Factors](#the-hidden-constant-factors)
    - [Cache Friendliness (The "Secret Sauce")](#cache-friendliness-the-secret-sauce)
  - [The "Worst Case" Trap](#the-worst-case-trap)
  - [Summary: Which one to pick?](#summary-which-one-to-pick)
- [Bubble Sort](#bubble-sort)
  - [The Core Logic: "Compare and Swap"](#the-core-logic-compare-and-swap)
  - [A Walkthrough Example](#a-walkthrough-example)
  - [Efficiency: Why we don't use it for big data](#efficiency-why-we-dont-use-it-for-big-data)
  - [The Python Implementation](#the-python-implementation)
  - [When should you actually use it?](#when-should-you-actually-use-it)
  - [Pointers and Optimization](#pointers-and-optimization)
    - [The "Bubble" Optimization](#1-the-bubble-optimization)
    - [The "Early Exit" (The swapped flag)](#2-the-early-exit-the-swapped-flag)
- [Selection Sort](#selection-sort)
  - [How Selection Sort Works](#how-selection-sort-works)
  - [A Walkthrough Example](#a-walkthrough-example-1)
  - [Selection Sort vs. Bubble Sort](#selection-sort-vs-bubble-sort)
  - [The Python Implementation](#the-python-implementation-1)
  - [The Big Picture: Which is which?](#the-big-picture-which-is-which)
- [Insertion Sort](#insertion-sort)
